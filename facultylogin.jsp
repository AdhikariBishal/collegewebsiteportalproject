<%-- 
    ...
    Created on : 27 Feb, 2024, 9:48:42 PM
...
<html>
    ...
    <body>
        <form method="post" action="facultyloginjsp.jsp">
            <div id="studentdiv">
        <div id="studenttopdiv">
            ...
            <div id="studentmid2div">
                <div id="studentmid21div">
                    ...
                    <div id="filldiv">
                        <input type="text " id="t2" name="t2" placeholder="Enter The Password" style="position: relative; height: 30px; border-radius: 5px; width: 450px; left: 20px; " >
                    </div>
                    ...
                    <div id="filldiv">
                        ...
                        <input type="text " id="t3" name="t3" placeholder="Enter The Captcha" style="position: relative; height: 30px; border-radius: 5px; width: 200px; left: 170px; top: -10px;" >
                    </div>
