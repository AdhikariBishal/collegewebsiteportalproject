<%-- 
    Document   : FacultyReg
    Created on : 27 Feb, 2024, 8:57:14 PM
...
<html>
    ...
    <body>
        <form method="post" action="facultyregjsp.jsp">
            <div id="enrolldiv">
        <div id="enrolltopdiv">
            ...
            <div id="detaildiv">
                ...
                <div id="detail2div">
                    ...
                    <div id="detail21div">
                        <input type="text " id="t2" name="t2" placeholder="Enter The Full Name" style="position: relative; height: 30px; border-radius: 5px; width: 350px; left: 20px;" >
                    </div>
                    <div id="detail21div">
