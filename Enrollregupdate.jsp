...
<html>
    ...
    <body>
        <form method="post" action="EnrollregUpdatejsp.jsp">
            <div id="enrolldiv">
        <div id="enrolltopdiv">
            ...
            <div id="detaildiv">
                ...
                <div id="detail2div">
                    ...
                    <div id="detail21div">
                        <input type="text" id="u3" name="u3" placeholder="Enter The Category" style="position: relative; height: 30px; border-radius: 5px;  width: 350px; left: 20px;" >
                    </div>
                </div>
                ...
                <div id="detail2div">
                    ...
                    <div id="detail21div">
                        <input type="text" style="position: relative; height: 30px; border-radius: 5px; width: 350px; left: 20px;" >
                    </div>
                    <div id="detail21div">
                        <input type="hidden" style="position: relative; height: 30px; border-radius: 5px;  width: 350px; left: 20px;" >
                    </div>
                </div>
